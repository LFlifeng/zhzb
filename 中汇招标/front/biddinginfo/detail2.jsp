...
<script src="${skin}front/js/time.js"></script>
...
<body>
	...
	<div class="arc_content">
		...
		<div class="arc fl"  id="bidsdetails">
			...
			<div class="arc_time">
			    <div class="t">中汇招标网受业主方委托推荐供应商，符合要求的供应商，我们将其资料提交给业主方供以选择，详情请咨询<i>400-688-2011</i></div>
		...
		<div class="sidebar_right fl fl10">
			<div class="new_did" id="exclusiveBids"  v-cloak>
				<div class="new_did_title">
					独家招标信息 <a class="new_did_title_more">更多</a>
				</div>
				<ul class="new_did_l" >
      ...
      <div class="tishi" style="display:none;">
        ...
        <p style="text-align: center;margin-top: 20px;color: #969696;font-size: 16px;">查看功能详情<span
            style="color: #969696;font-size: 16px;margin-left: 20px;">请咨询<i
              style="color: #ff2c36;font-size:18px;font-weight:700;margin-bottom:36px;">${systemInfo.servicePhone }</i></span></p>
      </div>
	<!-- 公共底部 -->
	<%@ include file="../common/footer.jsp"%>
	<script>
		var data = '${detail.deadline}'+' 23:59:59';
		data = data.replace("-","/");
		data = data.replace("-","/");
		function tips(){
