    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="trackerName" required lay-verify="required" placeholder="输入跟踪器名称" autocomplete="off"
                    class="layui-input">
            </div>
        </div>
        <!-- 设置关键词 -->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block clearfix">
                <input type="text" name="keywords" required placeholder="关键词一" autocomplete="off"
                    class="layui-input l">
                <input type="text" name="keywords"   placeholder="关键词二" autocomplete="off"
                    class="layui-input l">
                <input type="text" name="keywords"   placeholder="关键词三" autocomplete="off"
                    class="layui-input l">
                <input type="text" name="keywords"   placeholder="关键词四" autocomplete="off"
                    class="layui-input l">
                <input type="text" name="keywords"   placeholder="关键词五" autocomplete="off"
                    class="layui-input l">
            </div>
        </div>
        <!-- 地区选择 -->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="searchType" title="模糊搜索" lay-skin="primary" value="1">
                <input type="radio" name="searchType" title="精准搜索" lay-skin="primary" value="2">
            </div>
        </div>
        <!-- 订阅方式 -->
        <div class="layui-form-item">
