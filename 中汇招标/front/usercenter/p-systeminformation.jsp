...
<head>
    ...
    <link rel="stylesheet" href="${skin}front/css/p-systeminformation.css">
    <style>
    ...
    <div class="main">
        <div class="middle w clearfix">
            ...
            <div class="left l">
                ...
                <ul class="parentWrap">
                    <li class="menuGroup">
                        <span class="groupTitle"><a href="/systemQd.systeminformation.do">系统信息</a></span>
                    </li>
                    <li class="menuGroup">
                        <span class="groupTitle"><a href="/systemQd.paymentInstruction.do">消息通知</a></span>
                    </li>
                </ul>
            </div>
            <!-- 右侧 -->
