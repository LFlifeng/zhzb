            ...
            <div class="layui-form-item l">
              ...
              <div class="idcard clearfix">
                <div class="picture l">
                  ...
                  <button type="button" class="layui-btn layui-btn-normal uploadState sczmz" id="test2">上传正面照</button>
                  <p></p>
                  <input type="hidden" id="frontCard_id"lay-verify="required" name="frontCard" value="${company.frontCard}">
                </div>
        	 <div id='fmz'class="picture l">
              	<div class="photo ">
              	<img class="test3"src="${company.backCardUrl}">	
              	</div>
              	<button type="button" class="scfmz uploadState layui-btn layui-btn-normal" id="test3">上传反面照</button>
