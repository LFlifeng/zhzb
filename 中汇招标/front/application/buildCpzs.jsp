...
<form class="layui-form">
          ...
          <div class="layui-input-block">
             <input id='productName'type="text" name="productName" required  lay-verify="required" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
			    ...
			    <div class="layui-input-block">
			     	 <input id='productDescribe'type="text" name="productDescribe" required  lay-verify="required" placeholder="请输入产品描述" autocomplete="off" class="layui-input">
			    </div>
			    </div>
			    <div class="layui-form-item">
		              ...
		              <img url=''class="picture" style="width: 66px;height: 66px;">
            		  ...
            		  $.ajax({
	        			  ...
	        			  success:function(res)
	        			  {
    						 if(res=="succ")
    			             {
    							 ...
    							 //添加状态
    							 localStorage.setItem("buildCpzsSucc",true);
