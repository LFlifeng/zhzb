                ...
                <div class="mui-scroll"  id="userCollectionList">
                    <ul class="mui-table-view">
                        <li class="mui-table-view-cell mui-media" v-for="userCollection in userCollectionList" :key="userCollection.id">
                            <a :href="'bidsMobile.details.do?id=' +userCollection.id">
                                <div class="mui-media-body">
                                    {{userCollection.projectsName}}
                                  <%--   <div class="item_flex">
                                        <div class="flex"><i><img src="${skin}mobile/img/icon6.png"></i>wei'zhi'din</div>
                                        <div class="flex"><i><img src="${skin}mobile/img/icon7.png"></i>招标信息</div> 
                                        <div class="flex"><i><img src="${skin}mobile/img/icon8.png"></i>   {{userCollection.people}}</div>
                                    </div> --%>
                                </div>
                            </a>
                        </li>
